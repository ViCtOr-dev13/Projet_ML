...
################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################
    ...
    number_rate_filename = sum(c.isdigit() for c in parsed.path.split('/')[-1]) / len(parsed.path.split('/')[-2]) if '/' in parsed.path else 0
...
url="http://pinterest.com/pin/create/button/?url=http://www.greeteasy.com/i-am-lucky-to-have-a-teacher-like-you/&media=http://media.zumvu.com/2014/blog-photos/20140121-4-1390316369-161-1390316327.png"
data = parse_url(url)
